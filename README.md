...
Compiling is optional. If you prefer not to compile Discount yourself, you can download a pre-built release from the [Releases](https://github.com/jtnystrom/Discount/releases) page.
...
However, Discount should run on any platform where Spark can run. 
