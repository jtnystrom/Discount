 ...
 *
 * This radix sort algorithm was adopted for com.jnpersson and
 * RADIXSORT_NO_REC_SMALL was tuned below to give better performance for our use case.
 */
package com.jnpersson.util;
...
public final class LongArrays {
    ...
    //Tuned this for com.jnpersson (was 64 in fastutil)
    private static final int RADIXSORT_NO_REC_SMALL = 32;
